        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTerm = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    UnjustifiedAbsenceThreshold = table.Column<int>(type: "int", nullable: false),
                    LatenessToleranceMinutes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subjects = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    EmailNotifications = table.Column<bool>(type: "bit", nullable: false),
                    AppNotifications = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BehaviorReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BehaviorReports_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleText = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    Term = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Score1 = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Score2 = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Score3 = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Score4 = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    Score5 = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_CourseId_Date",
                table: "Attendance",
                columns: new[] { "CourseId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Attendance_StudentId_CourseId_Date",
                table: "Attendance",
                columns: new[] { "StudentId", "CourseId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BehaviorReports_Date",
                table: "BehaviorReports",
                column: "Date");

            migrationBuilder.CreateIndex(
                name: "IX_BehaviorReports_StudentId",
                table: "BehaviorReports",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_StudentId_CourseId_Term",
                table: "Grades",
